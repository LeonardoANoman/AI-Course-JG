...
class ComportamentoVendedor(FipaRequestProtocol):
    ...
    def handle_request(self, message):
        ...
        display_message(self.agente.aid.localname, "Recebeu a requisição")
        resposta = message.create_reply()
        resposta.set_performativa(ACLMessage.INFORM)
...
class ComportamentoComprador(FipaRequestProtocol):
    ...
    def handle_inform(self, message):
        display_message(self.agente.aid.localname, message.content)
